...
parser.add_argument('-c', '--config', default='MorphSNN_CIFAR10/CIFAR10aug/cifar10.yml', type=str, metavar='FILE',
...
def main():
    ...
    model = Model(node_num=4, in_channels=3, out_channels=64, num_classes=10).to(args.device)
