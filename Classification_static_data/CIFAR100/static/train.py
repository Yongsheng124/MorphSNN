...
parser.add_argument('-c', '--config', default='=MorphSNN_CIFAR10/CIFAR100SEblock/cifar100.yml', type=str, metavar='FILE',
...
parser.add_argument('-data-dir', metavar='DIR', default="datasets/CIFAR100",
...
def main():
    ...
    # from model import BetterModel
    # model = BetterModel(node_num=4, base_channels=64).to(args.device)


    from smodelT import Model
    model = Model(node_num=4, in_channels=3, out_channels=64, num_classes=100).to(args.device)
