...
def main():
    ...
    parser.add_argument('--data-dir', default="E:\\datasets\\CIFAR10-DVS", type=str)
    ...
    net = smodel.Model(node_num=7, in_channels=2, out_channels=112, num_classes=10).to(device)
