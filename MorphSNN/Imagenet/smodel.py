...
class Model(nn.Module):
    def __init__(self, node_num=5, in_channels=2, out_channels=64, num_classes=1000):
        ...
        self.stage1 = STSPBlock(6, out_channels, out_channels)

        self.stage2 = STSPBlock(16, out_channels, out_channels * 2)

        self.stage3 = STSPBlock(32, out_channels * 2, out_channels * 4)

        self.stage4 = STSPBlock(16, out_channels * 4, out_channels * 8)
