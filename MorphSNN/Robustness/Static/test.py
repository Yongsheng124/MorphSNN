...
model = Model(7,2,32).to("cuda:0")
location = "/home/hys/STSP/Robustness/Static/ER(5,0.75)C32T5_time1213_2120/best_model_ablation.pth"
...
model.eval()
test_set = DVS128Gesture(root="/home/hys/datasets/DVS128Gesture", train=False, data_type='frame', frames_number=5,
                         split_by='number')
